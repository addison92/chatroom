...
var createPcAndDataChannel = function (
  ...
  nowChannel.localChannel = nowChannel.pc.createDataChannel(
    localChannelOptions
 ...
 * 可以对多个pc一起发送
 */
var openVideoAudioRemote = function (webRtcs, is_video, is_audio) {
  //第一个参数是否启动视频,第二个参数是否启动音频
  if (webRtcs.length == 0) {
    return;
  }
  getUserMedia.call(
